                                ...
                                <?php if (count((array) $viewmore) > 0) {  //echo "<pre>";print_r($viewmore);exit;
                                    ...
                                    <div class="box-holder">
                                        ...
                                        <div class="blog">
                                            ...
                                            <h1 class="entry-title"><a href="http://demos.themebound.com/flatter/coupons/best-offer-on-computer-accessories/" rel="bookmark"><?php echo $viewmore->name; ?></a></h1>
                                            ...
                                            <div class="head-box">
                                                ...
                                                <div class="store-holder">
                                                    <div class="store-image">
                                                        <a href="http://demos.themebound.com/flatter/stores/homeshop/"><img src="<?php echo $viewmore->imageUrl; ?>" alt=""></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="coupon-main">
                                                    ...
                                                    <div class="couponAndTip">
                                                        ...
                                                        <div class="link-holder">
                                                            ...
                                                            <a href="<?php echo $viewmore->clickUrl; ?>" target="_blank" id="coupon-link-250" class="coupon-code-link btn coupon-hidden" title="Click to copy &amp; open site" target="_blank" data-coupon-nonce="b1e670b765" data-coupon-id="250" data-clipboard-text="COMP15"><span><i class="fa fa-lock"></i>Show Coupon</span></a>
                                                    ...
                                                    <div class="store-info">
                                                        <i class="icon-building"></i> <a href="http://demos.themebound.com/flatter/stores/homeshop/" rel="tag"><?php echo $viewmore->advtName; ?></a>									</div>
...
<!--                                                <div class="thumbsup-vote">
                                            ...
                                            <div class="text-footer iconfix">
                                                ...
                                                <div class="tags"><i class="fa fa-tags"></i>Tags:<a href="http://demos.themebound.com/flatter/coupon-tag/computer/" rel="tag">computer</a></div>

                                                <div class="stats"><i class="fa fa-bar-chart"></i>1386 total views, 5 today</div>
                                            ...
                                            <div class="author vcard">
                                                <a class="url fn n" href="http://demos.themebound.com/flatter/author/chetan/" rel="author">Chetan Parate</a>
                                            </div>
