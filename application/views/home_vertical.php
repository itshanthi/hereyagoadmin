                                            ...
                                            <?php foreach ($coupouns as $key => $row) {//echo "<pre>";print_r($coupouns); ?>
                                                <li>
                                                    <div class="slick-slider" >
                                                        <div class="slide">
                                                            <div class="image">
                                                                <a href="<?php echo base_url() . 'viewDiscount/' . $key . "?p=" . $this->input->get('p') . "&qcode=" . $this->input->get('qcode'); ?>" ><img  src="<?php echo $row->imageUrl; ?>" alt="" /></a>
                                                            </div>

                                                            <h3><a href="<?php echo base_url() . 'viewDiscount/' . $key . "?p=" . $this->input->get('p') . "&qcode=" . $this->input->get('qcode'); ?>" class="tooltip-links" title="<?php echo $row->desc; ?>"><?php echo word_limiter($row->name, 3); ?></a></h3>
                                                            ...
                                                            <a  class="btn blue" href="<?php echo base_url() . 'viewDiscount/' . $key . "?p=" . $this->input->get('p') . "&qcode=" . $this->input->get('qcode'); ?>">Learn More</a>
